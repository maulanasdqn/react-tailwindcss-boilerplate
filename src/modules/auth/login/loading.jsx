export const LoginModuleSkeleton = () => {
  return (
    <section className="flex items-center bg-gradient-to-l from-slate-300 via-sky-500 to-blue-300 justify-center h-screen w-full px-6">
      <div className="flex flex-col justify-center gap-y-3 h-auto animate-pulse p-8 bg-white shadow-md rounded-lg md:w-1/2 w-full">
